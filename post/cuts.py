...
cuts[1]['ZLF']= preselection + ' && ' + max1AddJet + ' && ' + minBtag + '>0' + ' && ' + maxBtag + '>0' + ' && ' + maxBtag + '<' + CSVT + ' && ' + dPhiVH + ' && H.pt > 100. && V.pt > 100.' + ' && Vtype == 1' # ee
cuts[0]['ZLF']= preselection + ' && ' + max1AddJet + ' && ' + minBtag + '>0' + ' && ' + maxBtag + '>0' + ' && ' + maxBtag + '<' + CSVT + ' && ' + dPhiVH + ' && H.pt > 100. && V.pt > 100.' + ' && Vtype == 0' # mumu
